...
namespace DataLessonsCours3.timeTableDataSetTableAdapters {
...
SELECT id_teacher, cathedra, name, firstName, otchestvo FROM Teacher WHERE (id_teacher = @id_teacher)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT id_teacher, cathedra, name, firstName, otchestvo FROM dbo.Teacher";
        ...
        public virtual int FillBy(timeTableDataSet.TeacherDataTable dataTable) {
