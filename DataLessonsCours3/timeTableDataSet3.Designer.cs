...
namespace DataLessonsCours3 {
    ...
    public partial class timeTableDataSet3 : global::System.Data.DataSet {
        ...
        public partial class TeacherDataTable : global::System.Data.TypedTableBase<TeacherRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TeacherRow AddTeacherRow(int id_teacher, string name, string firstName, string otchestvo) {
...
namespace DataLessonsCours3.timeTableDataSet3TableAdapters {
    ...
    public partial class TeacherTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Teacher] WHERE (([id_teacher] = @Original_id_teacher) AND ([na" +
                "me] = @Original_name) AND ([firstName] = @Original_firstName) AND ([otchestvo] =" +
                " @Original_otchestvo))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Teacher] SET [id_teacher] = @id_teacher, [name] = @name, [firstName] = @firstName, [otchestvo] = @otchestvo WHERE (([id_teacher] = @Original_id_teacher) AND ([name] = @Original_name) AND ([firstName] = @Original_firstName) AND ([otchestvo] = @Original_otchestvo));
SELECT id_teacher, name, firstName, otchestvo FROM Teacher WHERE (id_teacher = @id_teacher)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_teacher, name, firstName, otchestvo FROM dbo.Teacher";
        ...
        public virtual int Fill(timeTableDataSet3.TeacherDataTable dataTable) {
        ...
        public virtual timeTableDataSet3.TeacherDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            timeTableDataSet3.TeacherDataTable dataTable = new timeTableDataSet3.TeacherDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(timeTableDataSet3.TeacherDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_teacher, string Original_name, string Original_firstName, string Original_otchestvo) {
        ...
        public virtual int Update(int id_teacher, string name, string firstName, string otchestvo, int Original_id_teacher, string Original_name, string Original_firstName, string Original_otchestvo) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string firstName, string otchestvo, int Original_id_teacher, string Original_name, string Original_firstName, string Original_otchestvo) {
            return this.Update(Original_id_teacher, name, firstName, otchestvo, Original_id_teacher, Original_name, Original_firstName, Original_otchestvo);
        }
    }
